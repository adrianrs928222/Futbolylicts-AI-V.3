# Reglas canónicas de Futbolylicts-AI — v0.15
...
- Si la API no da cuota real/Bet Builder, se muestra una **cuota justa estimada** `EST.` derivada de la probabilidad del motor. Nunca se etiqueta como REAL ni valida el filtro de valor.

## Combinada diaria

- Nombre: **Combinada del dia**.
- Objetivo: @8–@10 (centro @9).
