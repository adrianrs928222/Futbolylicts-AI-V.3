...
export function overProbability(lambdaTotal: number, line: 0.5 | 1.5 | 2.5): number {
  ...
  if (line === 1.5) return 1 - poissonProbability(lambdaTotal, 0) - poissonProbability(lambdaTotal, 1);
  return 1 - poissonProbability(lambdaTotal, 0) - poissonProbability(lambdaTotal, 1) - poissonProbability(lambdaTotal, 2);
}
