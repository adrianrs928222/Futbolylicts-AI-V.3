...
export function buildBestCombo(date: string, allCandidates: MarketCandidate[]): DailyCombo {
  ...
  // v0.23: no publicamos una "Combinada del día" @2, @3 o @5. Si después de
  // revisar todo el pool ALTA/MUY ALTA no existe matemáticamente una @8–@10,
  // lo mostramos como no disponible en vez de engañar con una cuota fuera del objetivo.
  return {
    date, picks: [], totalOdds: 0, globalScore: 0, globalProbability: 0,
    globalConfidence: "BAJA", targetReached: false, official: false,
    message: "Hoy todavía no existe una combinación @8–@10 con los mercados ALTA/MUY ALTA analizados. El motor no publicará una cuota @2–@7 como Combinada del Día; amplía la criba y vuelve a revisar cuando haya más candidatos.",
  };
}
