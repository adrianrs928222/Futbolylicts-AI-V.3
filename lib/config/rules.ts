export const FUTBOLYLICTS_RULES = {
  ...
  // MUY ALTA exige 78% + 9.0/10. v0.17: la Combinada del día usa SOLO ALTA;
  // MUY ALTA se sigue mostrando en el análisis, pero no ocupa patas de la combinada.
  ...
  // v0.16: se ven todos los partidos elegibles del día, pero el análisis profundo
...
export const API_POLICY = {
  ...
  fixturesTtlSeconds: Number(process.env.CACHE_FIXTURES_TTL_SECONDS ?? 20 * 60),
